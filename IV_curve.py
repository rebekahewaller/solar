...
def r1_on_off():
    """Switch on/off relay 1"""
 
    r1_cmd_packet = b'\x04\x14\x01\x00\x00\xe7\x0f'
    ser_relay.write(r1_cmd_packet)
...
def check_relay_status():
    """Query current status of all relays (on/off)"""
...
def sweep_relay():
    """Go down relay card and take IV curve from each OPV starting with 1"""
